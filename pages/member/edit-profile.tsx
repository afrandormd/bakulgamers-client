                ...
                <div className="ps-lg-0">
                    ...
                    <div className="bg-card pt-30 ps-30 pe-30 pb-30">
                        <form action="">
                            <div className="photo d-flex">
                                <div className="position-relative me-20">
                                    ...
                                    <div
                                        ...
                                        <Image src="/icon/trash.svg" alt="delete-icon" width={24} height={24} />
                                    </div>
                                </div>
                                <div className="image-upload">
                                    <label htmlFor="avatar">
                                        <Image src="/icon/upload.svg" alt="upload-icon" width={90} height={90} />
                                    </label>
                            ...
                            <div className="pt-30">
                                <Input label="Phone" type="text" placeholder="Enter your phone number" />
                            </div>
