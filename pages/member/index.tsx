                            ...
                            <table className="table table-borderless">
                                ...
                                <tbody>
                                    <tr className="align-middle">
                                        <th scope="row">
                                            <img className="float-start me-3 mb-lg-0 mb-3" src="/images/overview-1.png"
                                    ...
                                    <tr className="align-middle text-center">
                                        <th scope="row">
                                            <img className="float-start me-3 mb-lg-0 mb-3" src="/images/overview-2.png"
                                                width="80" height="60" alt="" />
                                            <div className="game-title-header">
                                    ...
                                    <tr className="align-middle text-center">
                                        <th scope="row">
                                            <img className="float-start me-3 mb-lg-0 mb-3" src="/images/overview-3.png"
                                                width="80" height="60" alt="" />
                                            <div className="game-title-header">
                                    ...
                                    <tr className="align-middle text-center">
                                        <th scope="row">
                                            <img className="float-start me-3 mb-lg-0 mb-3" src="/images/overview-4.png"
                                                width="80" height="60" alt="" />
                                            <div className="game-title-header">
