...
export default function Auth(props: Partial<AuthProps>) {
            ...
            <li className="nav-item my-auto dropdown d-flex">
                ...
                <div>
                    <a className="dropdown-toggle ms-lg-40" href="#" role="button" id="dropdownMenuLink"
                        ...
                        <img src="/images/avatar-1.png" className="rounded-circle" width="40" height="40"
                            alt="" />
                    </a>
    ...
    return (
        <li className="nav-item my-auto">
            <Link href="/sign-in" className="btn btn-sign-in d-flex justify-content-center ms-lg-2 rounded-pill" role="button">Sign In</Link>
        </li>
    )
}
