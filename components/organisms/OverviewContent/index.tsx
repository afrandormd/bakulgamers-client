            ...
            <div className="ps-lg-0">
                ...
                <div className="top-up-categories mb-30">
                    ...
                    <div className="main-content">
                        <div className="row">
                            <Category icon="icon-desktop" nominal={18000500}>Game <br /> Desktop</Category>
                            <Category icon="icon-mobile" nominal={8455000}>Game <br /> Mobile</Category>
                            <Category icon="icon-desktop" nominal={5000000}>Other <br /> Categories</Category>
                        </div>
                    </div>
                </div>
